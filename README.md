...
**One-use member-bound voucher redemption for cvld/cfrm admission.**

`cfrm` owns who may sponsor and policy. `cvch` proves a voucher was validly
redeemed for one member, once, without revealing sponsor identity.
